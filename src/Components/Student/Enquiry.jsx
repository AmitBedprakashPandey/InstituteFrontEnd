    ...
    <div className="relative   bg-white">
      ...
      <div className="p-3 m-4 border-t-4 rounded-lg border-blue-500 shadow-md">
        <div className="flex justify-between">
          <strong className="text-xl">Register Enquries</strong>
      ...
      <div className="border-t-4 rounded-lg border-blue-500 shadow-md m-4">
        ...
        >
          ...
          <Column field="quantity" header="Course" sortable></Column>
          <Column field="quantity" header="Email" sortable></Column>
          <Column field="quantity" header="Mobile No." sortable></Column>
          <Column field="quantity" header="Enquiry Date" sortable></Column>
          <Column field="quantity" header="Enquiry By" sortable></Column>
          <Column field="quantity" header="Enquiry Status" sortable></Column>
          <Column
            field="quantity"
            header="Action"
